...
# sunxi 3.4.x
#--------------------------------------------------------------------------------------------------------------------------------
setenv bootargs console=ttyS0,115200 console=tty0 console=tty1 sunxi_g2d_mem_reserve=256 sunxi_ve_mem_reserve=256 hdmi.audio=EDID:0 disp.screen0_output_mode=1920x1080p60 root=/dev/mmcblk1p2 rootfstype=ext4 elevator=deadline rootwait
